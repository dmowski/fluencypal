...
When asked what happened today / “what's going today”, follow that analytics guide (and the `analyze-analytics-report` skill): export from the last report through now (usually one UTC day; the full gap if a day was skipped), pull matching Sentry issues, then write the short report. Do not skip `INTERVENTIONS.md`, `LAST_REPORT.md`, or Sentry.
