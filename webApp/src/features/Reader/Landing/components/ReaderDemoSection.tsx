  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubTitle>
          This is the same reading surface from the app — not a mockup. Click a word to translate
          it, drag to select text and highlight, or open settings to try text-to-speech.
        </SubTitle>
        <BodyText>
