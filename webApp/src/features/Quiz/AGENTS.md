...
- **Polish B1 Speaking:** dashboard group `Polish B1 — Mówienie` → `ExamVariantPicker` (30 variants + random) → `exam/polishB1Speaking/*`; photo tasks use `/examQuiz/*.webp` (20 generated) + legacy Firebase images
