...
export const PhrasesArticles = ({
  ...
  return (
    ...
    >
      <Typography>
        {i18n._(
          `At the end, we’ll share a valuable tool for realistic interview practice.`,
        )}
      </Typography>
      ...
      <Box sx={{ py: 2 }}>
        ...
        <Typography>
          {i18n._("After the greeting, you'll usually hear:")} “Tell me about
          yourself.”{" "}
          {i18n._(
        ...
        <Box sx={{ borderLeft: "4px solid", pl: 2, my: 2 }}>
          <Typography variant="body1" fontWeight="bold">
            “Sure. I am a [position] with X years of experience in [industry]. I
            previously worked at [company] where I [key achievement]. I’m
        ...
        >
          “I am a marketing specialist with 5 years of experience in digital
          advertising. I previously worked at an e-commerce company where I led
          a project that increased sales by 30%. I’m excited about this
          opportunity at ABC Corp because I admire your innovative campaigns.”
        </Typography>
      ...
      <Box sx={{ py: 2 }}>
        ...
        <Typography paragraph fontWeight="bold">
          “I managed to…” –{" "}
          {i18n._("This shows results and makes you stand out.")}
        </Typography>
        ...
        <Typography>
          ...
          <br />
          <strong>
            “I’m impressed by your company’s mission and values. I want to be
            part of a team that [does something meaningful in the field].”
          </strong>
        </Typography>
        ...
        <Typography>
          ...
          <br />
          <strong>
            “I have a proven track record in [skill/area]. For example, in my
            last role I [achievement]. I’m confident I can bring the same
            success here.”
          </strong>
        </Typography>
        ...
        <Typography>
          ...
          <br />
          <strong>
            “In five years, I see myself growing into a senior role where I can
            lead projects and contribute even more to the company’s success.”
          </strong>
        </Typography>
        ...
        >
          ...
          “What motivates you?”, “Tell me about a challenge you overcame.”,
          “What are your salary expectations?”{" "}
          {i18n._(
            "Prepare short, honest, and positive answers with real-life examples.",
          )}
        </Typography>
      ...
      <Box sx={{ py: 2 }}>
        ...
        <Typography>
          ...
          <br />
          <strong>
            “One of my strengths is adaptability. I quickly adjust to new
            software or processes – at my last job I learned a new CRM system in
            just two weeks.”
          </strong>
        </Typography>
        <Typography>
          {i18n._("Other useful strengths:")} team player, detail-oriented,
        ...
        <Typography>
          ...
          <br />
          <strong>
            “I used to feel nervous speaking in front of large groups, but I’ve
            been taking public speaking classes to improve. It’s getting much
            easier for me.”
          </strong>
        </Typography>
        <Typography>
          <strong>
            “One area I’m working on is delegating tasks – sometimes I try to do
            everything myself. I’m learning to trust my team members more.”
          </strong>
        </Typography>

        <Typography>
          {i18n._("This approach shows self-awareness and growth.")}
        </Typography>
        ...
        <Typography>
          {i18n._("At the end of the interview, you’ll usually be asked:")} *“Do
          you have any questions for us?”*{" "}
          {i18n._("Never say “no.” Prepare 2–3 smart questions in advance:")}
        </Typography>
        ...
        <Typography>
          ...
          <strong>“Would it be possible to…”</strong>
        </Typography>
        <Typography>
          {i18n._(
      ...
      <Box sx={{ py: 2 }}>
        ...
        <Typography>
          ...
          <br />
          <strong>
            “Thank you once again for the interview yesterday – I appreciated
            the chance to learn more about [Company].”
          </strong>
        </Typography>
        ...
        >
          ...
          <br />
          <strong>
            {i18n._("Good preparation today means career success tomorrow.")}
          </strong>
        </Typography>
      </Box>
    </Stack>
