...
export const voiceAvatarMap: Record<AiVoice, AiAvatar> = {
  ...
  ash: {
    ...
    helloPhrases: ["Hey there! I'm Ash, your friendly AI companion. "],
  },
  // girl
  shimmer: {
    ...
    helloPhrases: ["Hello! Shimmer here, ready to add a touch of allure to our conversation."],
  },
  ...
  marin: {
    ...
    helloPhrases: [
      "Hello! Marin here, your gentle and calming AI companion. How can I support you today?",
    ],
  },
  ...
  verse: {
    ...
    talkVideoUrl: ["/call/verse/talk.webm"],
    ...
    helloPhrases: ["Greetings! Verse here, your confident Teacher"],
  },
};
