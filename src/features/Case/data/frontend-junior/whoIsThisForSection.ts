...
export const getWhoIsThisForSection = (lang: SupportedLanguage): TextListSection => {
  ...
  return {
    ...
    subTitle: i18n._("Designed specifically for aspiring and junior frontend engineers"),
    textList: [
      { title: i18n._("Recent graduates or bootcamp alumni entering frontend development") },
      { title: i18n._("Junior developers preparing for their first professional frontend role") },
      {
        title: i18n._(
      ...
      {
        title: i18n._("Professionals transitioning from other fields into frontend engineering"),
      },
      {
        title: i18n._(
