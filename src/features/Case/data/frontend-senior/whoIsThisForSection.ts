...
export const getWhoIsThisForSection = (lang: SupportedLanguage): TextListSection => {
  ...
  return {
    ...
    textList: [
      { title: i18n._("Senior Frontend Developers preparing for promotions or new roles") },
      { title: i18n._("Frontend engineers interviewing for Senior, Lead, or Staff positions") },
      {
        title: i18n._(
